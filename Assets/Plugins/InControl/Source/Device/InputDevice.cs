	...
	public class InputDevice
	{
		...
		public void Commit( ulong updateTick, float deltaTime )
		{
			...
			if (IsKnown)
			{
				...
				StartOrSelect.Passive = passive;
				StartOrSelect.CommitWithState( pressed, updateTick, deltaTime );
			}
		...
		{
			get { return IsKnown && StartOrSelect.IsPressed; }
		}
		...
		{
			get { return IsKnown && StartOrSelect.WasPressed; }
		}
		...
		{
			get { return IsKnown && StartOrSelect.WasReleased; }
		}
		...
		public InputControl StartOrSelect
		{
